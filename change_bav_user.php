        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="font-size: 16px;">
                ...
                <div class="container-fluid">
                    <form method="POST" action="bav_order_user.php?idcake=<?php echo $erow['idcake']; ?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <input type="number" name="discount" style="font-size: 14px; width: 20rem;" id="discount" class="form-control" value=0>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <input type="number" name="money" style="font-size: 14px; width: 20rem;" id="money" class="form-control" value="  0">
                            </div>
                        </div>
