...
<div class="wrapper fadeInDown">
  ...
  <div id="formContent">
    ...
    <form name="formlogin" action = "checklogin.php" method = "POST" id="login">
      <input type="text" id="username" class="fadeIn second" name="username" placeholder="ชื่อผู้ใช้">
      <input type="password" id="password" class="fadeIn third" name="password" placeholder="รหัสผ่าน">
      <input style="font-size:15px;"type="submit" class="fadeIn fourth" value="เข้าสู่ระบบ">
    </form>
