                ...
                <form action="index_user.php" method="POST">
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <input value="1ปอนด์" class="dropdown-item" style=" font-size: 14px;width:185px;height:38px; " type="submit" name="1pond" href="index_user.php"></a>
                            <input value="2ปอนด์" class="dropdown-item" style=" font-size: 14px;width:185px;height:38px; " type="submit" name="2pond" href="index_user.php"></a>
                            <input value="3ปอนด์" class="dropdown-item" style=" font-size: 14px;width:185px;height:38px; " type="submit" name="3pond" href="index_user.php"></a>
                            <input value="ชิ้น" class="dropdown-item" style=" font-size: 14px;width:185px;height:38px; " type="submit" name="cin" href="index_user.php"></a>
                        </div>
                    </div>
                </form>
            </li>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item active">
                                        <a class="nav-link" href="index_user.php"><i class='fas fa-cart-plus' style='font-size:20px'></i>&nbsp;จัดการคำสั่งซื้อ </a>
                                    </li>&nbsp;&nbsp;&nbsp;
                                    <li class="nav-item">
                                                                ...
                                                                <div class="form-row align-items-center">
                                                                 ...
                                                                 <?php  if (isset($_POST['set'])) {
                                                                    ...
                                                                    $querycommentee = "UPDATE `comment`  SET  `comment_name`='$commentdd'  WHERE `comment`.`id` = 1 ";
                                                                        ...
                                                                        echo "<meta http-equiv='refresh' content='0.25;URL=bav_order_user.php'>";
                                                            }
                                                            
                                                             ?>
                        <?php include('comment_bav_user.php'); ?> <?php  include('change_bav_user.php'); ?>
