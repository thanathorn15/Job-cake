                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <center><a type="button" href="addcake_user.php" class="btn btn-success" style="width:127px;height:34px;font-size: 14.5px;"><i class="fas fa-plus">&nbsp;&nbsp;เพิ่มรายการ</i></a></center>
                                    <br>
                                    ...
                                    <?php  }
                                        ...
                                        <a href='editcake_user.php?editidcake=" . $idcake . "' class='btn btn-warning'  style='width:60px;height:30px;font-size: 13px'; ><i class='far fa-edit'></i>
                                       

                                        </a>
                                        <a href='delcake_user.php?delidcake=" . $idcake .
