                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <center><a type="button" href="addbav.php" class="btn btn-success" style="width:127px;height:34px;font-size: 14.5px;"><i class="fas fa-plus">&nbsp;&nbsp;เพิ่มรายการ</i></a></center>
                                    <br>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td class=t-center> <ul>
                                              <a href='editbav.php?editidbav=" . $bev_id . "' class=' btn btn-warning btn-lg' style='width:60px;height:30px;font-size: 13px'; ><i class='far fa-edit'></i>
                                                  
                                              </a>
                                              <a href='delbav.php?delidbav=" . $bev_id . "' onclick='return confirm(\"คุณแน่ใจที่ต้องการลบ?\");' class='btn btn-danger btn-lg' style='width:60px;height:30px;font-size: 13px'; ><i class='fas fa-trash-alt'></i>
