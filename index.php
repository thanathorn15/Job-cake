                                                    ...
                                                    <div class="form-row align-items-center">
                                                        <div class="botton">
                                                            <form  method="post"><br>
                                                             ...
                                                             ?>
                        <?php include('comment.php'); ?> <?php  include('change.php'); ?>
...
if (isset($_POST['add'])) { 
    ...
    if ($resultsx->num_rows > 0) {
        ...
        $query = "INSERT INTO `waitorder`(`id`, `idproduct`, `name`, `price`, `unit`,`priceperunit`,`amount`,`datetime`,`day`,`month`,`year`,`employee`,`billID`,`price_vat`,`discount`) 
               VALUES (' $billno ','$idproduct','$name','$price','$unit','$priceperunit','$amount','$today' ,'$day' ,'$month' ,'$year' ,'$nameuser' ,001,'$price_vat','$discount')";
...
if (isset($_POST['del'])) {
    ...
    $query4 = "UPDATE `waitorder` SET `price_novat` = `price`+`price`*7/100 WHERE `waitorder`.`idproduct` = '$idproduct'";
    $result = $conn->query($query4);
